...
| ----------- | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | :------: |
| index       | [integer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Integer) | In which actionRow the selectMenu appears, a selectMenu requires one whole row for it alone. |   true   |
...
| minValues   | [integer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Integer) | SelectMenu minimal value of selectable options                                               |   true   |
| maxValues   | [integer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Integer) | SelectMenu maximal value of selectable options                                               |   true   |
