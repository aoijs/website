...
<Tabs>
    <TabItem label="npm" icon="seti:npm">
        ...
        ```bash
            npm install @aoijs/aoi.music ffmpeg-static
        ```
    ...
    <TabItem label="pnpm" icon="pnpm">
        ...
        ```bash
            pnpm add @aoijs/aoi.music ffmpeg-static
        ```
    ...
    <TabItem label="yarn" icon="seti:yarn">
        ...
        ```bash
            yarn add @aoijs/aoi.music ffmpeg-static
        ```
    ...
    <TabItem label="bun" icon="bun">
        ...
        ```bash
            bun install @aoijs/aoi.music ffmpeg-static
        ```
