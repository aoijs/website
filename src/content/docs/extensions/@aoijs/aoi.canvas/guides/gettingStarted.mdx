...
* [$createCanvas](/extensions/aoicanvas/functions/createcanvas/) - to create canvases.
* [$attachCanvas](/extensions/aoicanvas/functions/attachcanvas/) - to send canvases.

We also need to know about:
* [$drawImage](/extensions/aoicanvas/functions/drawimage/) - to add external images. (like user avatars)
* [$fillRect](/extensions/aoicanvas/functions/fillRect/) - to draw rects on your canvas.
* [$fillText](/extensions/aoicanvas/functions/filltext/) - to write text on your canvas.