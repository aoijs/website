...
Sharding is **required** once passing 2,500 guilds, this is a Discord limitation.

__You should think about sharding once hitting 2,000 guilds.__

Discord will prevent your client from connecting to the gateway if you exceed this limit.
