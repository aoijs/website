...
description: This guide will be covering how to start creating commands, how to use command handlers, how to create multiple commands in one file and how to update commands without restarting your Discord Bot.
type: guide
id: commands
