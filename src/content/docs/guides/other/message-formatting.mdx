...
<DiscordMentionComponent client:load client:only="react">
    ...
    <DiscordMention type="channel">rules</DiscordMention>, <DiscordMention type="voice">General</DiscordMention>, <DiscordMention type="forum">feedback</DiscordMention> and roles{" "}
