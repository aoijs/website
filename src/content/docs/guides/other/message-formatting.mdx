...
<div styles={{ marginTop: "2rem" }}>
    <DiscordMentionComponent client:load transition:persist client:only="react">
        Hey, <DiscordMention type="user">Leref</DiscordMention> and <DiscordMention type="user">Ayaka</DiscordMention>. This looks very nice, doesn't it? You can also mention channels
        <DiscordMention type="channel">rules</DiscordMention>, <DiscordMention type="voice">General</DiscordMention>, <DiscordMention type="forum">feedback</DiscordMention> and roles <DiscordMention type="role" color="#70f0b4">Support</DiscordMention>!
