...
|  Premium  |   6   | premium button that allows purchases (only usable if you have monitarization enabled & converts automatically to user's currency!) | `{button:Button:primary:customID:false:emojiName or emojiID or emoji String}` |
