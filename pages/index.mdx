...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Create powerful Discord Bots <br className='sm:block hidden'/>with aoi.js</h1>
    <p className="subtitle">Advanced, powerful and easy <br className='sm:block hidden'/>creation of Discord Bots</p>
