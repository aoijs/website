...
import docsCard from '../images/og/1.png'
import extensionsCard from '../images/extensions-front.png'
import styles from './index.module.css'

<meta property="og:url" content={"https://aoi.js.org"} />
<meta name="og:image" content={"https://raw.githubusercontent.com/aoijs/website/main/images/og/1.png"} />
<meta property="og:title" content={"aoi.js | Akarui Development"} />
<meta property="og:description" content={"The most advanced string package to create your own Discord Bot"} />
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Create Discord bots <br className='sm:block hidden'/>with ease</h1>
    <p className="subtitle">Simple, powerful and easy to use <br className='sm:block hidden'/>string based package</p>
    <br />
      ...
      <Features>
        ...
        <Feature index={1} centered className="card-with-border" href="/docs">
          <div className="h-full flex flex-col justify-between">
            <h3>Get Started</h3>
            <p className='text-left mb-8'>Create your Discord Bot within minutes using our CLI tool.</p>
            <br />
            <div>
              <div className={styles.optimization}>
                <div style={{ fontSize: '.9rem' }} className="leading-8">
                  <code>{`npm install -g @akarui/aoi.cli`}</code> <br /> <code>{`npx aoijs create`}</code>
                </div>
              </div>
            </div>
          </div>
        </Feature>
        <Feature index={2} centered className="card-with-border" href="/extentions">
          <br />
          <h3>String based functions</h3>
          <br />
          <p>With string based functions, you can create and edit your code without actual JavaScript knowledge.</p>
          <br />
          <br />
        </Feature>
        <Feature index={3} large centered id="docs-card" href="/extensions">
          <Image src={extensionsCard} alt="Background" loading="eager" />
        </Feature>
      </Features>
    </div>
  </div>
