...
| ------- | ------- | ------------------------------------------------------ |:------------:|
| guildID | integer | The ID of a specific guild.                            |     так      |
| userID? | integer | The user who executed the action stated in audit logs. |      ні      |
| limit?  | number  | The maximum of audit logs it will return.              |      ні      |
| action? | integer | The action that was executed.                          |      ні      |
| format? | рядок   | The format to return the audit logs in.                |      ні      |
