---
title: '$color'
description: '$color changera la couleur d''un embed.'
id: color
---

`$color` changera la couleur d'un embed
...
| ------ | -------------------- | ---------------------------------------------------------------------------------------- |:-----------:|
| index? | entier               | L'index de l'embed.                                                                      |    Faux     |
| hex    | chaîne de caractères | La couleur hexadécimale ou le nom de la couleur (noms de couleurs supportés ci-dessous). |    vrai     |

<details>
  <summary><h3> Couleurs des embeds </h3></summary>
...
Cela retournera un embed rouge :
